...
subtitle: Typescript Challenges 7 - Readonly
category: til
tags: ['typescript']
slug: /230115
---
...
ReadonlyArray 타입의 배열은 `push`, `pop` 등을 사용하여 배열을 수정하거나, 배열 안에 있는 값을 재할당할 수 없다.

`ReadonlyArray<Type>`는 줄여서 `readonly Type[]`로 표현할 수 있다.
